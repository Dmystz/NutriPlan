            ...
            <div class="collapse navbar-collapse py-xl-3 py-4" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mb-xl-0 align-items-center mb-3">
                        ...
                        <li class="nav-item">
                            <a class="me-xl-2 btn align-items-center d-flex nav-link oren rounded-pill text-white fw-bold item"
                                ...
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M3 9V18C3 20.2091 4.79086 22 7 22H17C19.2091 22 21 20.2091 21 18V9M3 9V7.5C3 5.29086 4.79086 3.5 7 3.5H17C19.2091 3.5 21 5.29086 21 7.5V9M3 9H21M16 2V5M8 2V5" stroke="white" stroke-width="1.5" stroke-linecap="round" /></svg></span>
                                Meal Plans
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="me-xl-2 btn align-items-center d-flex nav-link ijo rounded-pill text-white fw-bold item"
                                ...
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <defs><clipPath id="clip0_102_1720"><rect width="24" height="24" fill="white" /></clipPath></defs></svg></span>
                                Analytic
                            </a>
                        </li>
                    </ul>
                ...
                <div class="d-flex justify-content-center flex-grow-0">
                    <ul class="navbar-nav align-items-center mb-xl-0">
                        <li class="nav-item item d-flex">
                            ...
                            <a href="#" class="btn text-center nav-link ijo-bunder flex-grow-0 me-2"
                                style="width:38px; height:38px; padding:0; display:flex; align-items:center; justify-content:center;">
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 23 23" fill="none">
                            ...
                            <a class="btn text-center nav-link oren-bunder me-2 flex-grow-0 p-0 overflow-hidden" href="#"
                                ...
                                style="width:38px; height:38px; display:flex; align-items:center; justify-content:center;
                                       font-weight:700; font-size:0.85rem; color:white; border-radius:50%;">
                    ...
                    <div class="user-account-info">
                        <h6 class="mb-0 fw-bold info-user">
                            {{ session('user_name') ?? (Auth::user()->name ?? 'Guest') }}
                        </h6>
                        <p class="mb-0 info-user">
...
<div class="container-fluid min-vh-100 px-5 lat-blkg konten">
    ...
    <style>
        ...
        .btn-edit-profile:hover { background: #95cd41; color: #fff; }
        .btn-logout-profile {
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        @media (max-width: 576px) {
            ...
            .profile-modal-header { padding: 1.25rem 1.25rem 2.5rem; }
            .profile-avatar { width: 54px; height: 54px; font-size: 1.3rem; }
            .profile-body { padding: 1.25rem; }
            .profile-info-value { font-size: 0.82rem; }
            .btn-edit-profile, .btn-logout-profile { font-size: 0.82rem; padding: 0.5rem 0.75rem; }
        }
    </style>

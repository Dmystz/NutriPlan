                            ...
                            <a class="me-xl-2 btn align-items-center d-flex nav-link ijo rounded-pill text-white fw-bold item"
                                ...
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path
                                            ...
                                            fill="white" />
                                        <path
                                            d="M20.0325 2.16797C19.4737 1.36945 18.7177 0.929626 17.9038 0.929626C17.0899 0.929626 16.334 1.36926 15.775 2.16778C15.2442 2.92622 14.9519 3.92817 14.9519 4.98872C14.9519 6.04945 15.2443 7.05122 15.7751 7.80947C16.0675 8.22732 16.4142 8.54574 16.7945 8.75541L16.4283 21.9268V21.927C16.4178 22.2247 16.5297 22.5137 16.7379 22.7268C16.9508 22.9474 17.2447 23.0714 17.5513 23.0699H18.2564C18.5629 23.0714 18.8568 22.9474 19.0696 22.7268C19.2774 22.5142 19.3893 22.226 19.3792 21.9288L19.013 8.75554C19.3933 8.54589 19.7401 8.22726 20.0324 7.80961C20.5635 7.05136 20.8558 6.04978 20.8558 4.98886C20.8558 3.92793 20.5635 2.92636 20.0325 2.16811V2.16797Z"
                                            fill="white" />
                                        <path
                                            d="M6.46502 0.930001C6.26122 0.930001 6.09606 1.09534 6.09606 1.29914V4.98909H5.35797V1.29914C5.35797 1.09534 5.19281 0.930001 4.98901 0.930001C4.78521 0.930001 4.62005 1.09534 4.62005 1.29914V4.98909H3.88196V1.29914C3.88196 1.09534 3.7168 0.930001 3.513 0.930001C3.3092 0.930001 3.14404 1.09534 3.14404 1.29914V6.48539C3.14441 6.77195 3.21106 7.05431 3.33887 7.31063L3.87976 8.39222L3.51354 21.9269C3.50329 22.2246 3.61517 22.5136 3.82336 22.7267C4.03613 22.9473 4.33003 23.0713 4.63655 23.0698H5.34169H5.34151C5.64821 23.0713 5.94193 22.9473 6.15469 22.7267C6.36252 22.5143 6.47439 22.2261 6.46451 21.9291L6.09848 8.39203L6.63937 7.31044H6.63919C6.767 7.05409 6.83364 6.77175 6.83401 6.4852V1.29895C6.83401 1.20099 6.79519 1.10725 6.72598 1.03803C6.65676 0.968814 6.56301 0.929813 6.46505 0.929813L6.46502 0.930001Z"
                                            fill="white" />
                                    </svg></span>
                                Nutrition
                            </a>
                    ...
                    <ul class="navbar-nav align-items-center mb-xl-0">
                        <li class="nav-item item d-flex">
                            ...
                            <div class="notif-bell-wrap">
                                {{-- Tombol bell — data-bs-toggle membuka #notifikasiModal --}}
                                <a href="#" class="btn text-center nav-link ijo-bunder flex-grow-0 me-2"
                                    data-bs-toggle="modal" data-bs-target="#notifikasiModal"
                                    style="width:38px; height:38px; padding:0; display:flex; align-items:center; justify-content:center;"
                                    title="Notifikasi Makan">
                                    <span>
                                ...
                                {{-- Badge unread count — disembunyikan via JS saat count = 0 --}}
                                <span class="notif-nav-badge" id="notifNavBadge">3</span>

                            </div>

                            {{-- Sertakan modal di dalam layout (letakkan sebelum </body>) --}}
                            @include('components.modal_notifikasi')

                            {{-- Avatar navbar: klik → buka profileModal --}}
                            <a class="btn text-center nav-link oren-bunder me-2 flex-grow-0 p-0 overflow-hidden"
            ...
            <div class="modal-content profile-modal-content">
                ...
                <div class="profile-modal-header">
                    ...
                    <div class="text-center mt-2">
                        ...
                        <div class="profile-avatar" data-bs-toggle="modal" data-bs-target="#photoPreviewModal"
                            title="Lihat foto">
                            @if (session('user_photo'))
                                <img src="{{ asset('storage/' . session('user_photo')) }}"
                                    style="width:64px;height:64px;object-fit:cover;" alt="foto profil">
                            @else
                                {{ strtoupper(substr(session('user_name') ?? (session('name') ?? '?'), 0, 1)) }}
                            @endif
                        </div>

...
(function () {
    ...
    function renderTimeline(grouped) {
        ...
        // Flatten semua log dengan info slot-nya
        let allLogs = [];
        SLOTS.forEach(slot => {
        ...
        // Sort by actual meal_time, fallback ke default slot time
        allLogs.sort((a, b) => {
            ...
            row.innerHTML = `
                ...
                <div class="wrapper-content-meal-days d-flex px-2 py-2 flex-grow-1">
                    <div class="d-flex align-items-center flex-shrink-0">
                        ${log.image_path
                            ? `<img src="${log.image_path}" alt="${log.name}" class="gambar-meal" onerror="this.style.display='none'">`
